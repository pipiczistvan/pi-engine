package piengine.io.loader.obj.parser;
...
public class ObjParser {
    ...
    public ObjDto parseSource(final String[] source) {
        ...
        return new ObjDto(verticesArray, indicesArray, texturesArray, normalsArray);
    }
